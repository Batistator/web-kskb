...
export default function DateRangePickerComponent({ onDateRangeChange, startDate, endDate }: DateRangePickerProps) {
  ...
  const datesMap = {
    ...
    rangeT4: ["2026-01-19", "2026-07-05"],
    rangeT5: ["2026-07-06", "2027-12-31"],
  };
  ...
  const descriptionsMap = {
    ...
    rangeT5: "Rango de fechas de la temporada 5 de CS2",
  };
      ...
      <ButtonGroup variant="flat">
        ...
        <Dropdown placement="bottom-end">
          ...
          >
            ...
            <DropdownItem key="rangeT5" description={descriptionsMap["rangeT5"]}>
              {labelsMap["rangeT5"]}
            </DropdownItem>
          </DropdownMenu>
        </Dropdown>
